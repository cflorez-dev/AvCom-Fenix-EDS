...
export default async function decorate(block) {
  ...
  block.innerHTML = '';
  block.className = 'cms-hero-banner h-[457px] min-[1248px]:h-[324px] p-4 min-[1248px]:p-6 rounded-2xl box-border overflow-hidden relative w-full text-[var(--text-normal-lighter)] flex justify-center items-end md:h-[457px]';
